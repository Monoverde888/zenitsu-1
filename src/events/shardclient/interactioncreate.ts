...
function iteractionCreate(_client: detritus.ShardClient, _commandClient: CommandClientType, data: detritus.GatewayClientEvents.InteractionCreate) {
...
export default iteractionCreate;
